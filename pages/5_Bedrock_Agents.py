...
agent_id = os.environ.get('AGENT_ID', 'FGHZDGD18V')
agent_alias_id = os.environ.get('BEDROCK_AGENT_ALIAS_ID', '0AVFFPQBTT')
...
st.set_page_config(page_title="Agents for Amazon Bedrock - Bellagio Bazaar", page_icon=":robot:", layout="wide")
st.subheader('Agents for Amazon Bedrock - Bellagio Bazaar', divider='orange')
...
with st.sidebar:
        ...
        sample_question = st.selectbox(
            ...
            (
                "Can you present Bellagio Bazaar's product inventory in a tabular format?",
                "What's the current status of Bellagio Bazaar's inventory?",
